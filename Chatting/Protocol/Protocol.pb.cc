...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_Protocol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::S_TEST, playertype_),
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_Protocol_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "Protocol.BuffData\022(\n\nplayerType\030\005 \001(\0162\024."
...
void S_TEST::InternalSwap(S_TEST* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(S_TEST, playertype_)
      + sizeof(S_TEST::playertype_)
