...
// .Protocol.PlayerType playerType = 5;
inline void S_TEST::clear_playertype() {
  playertype_ = 0;
}
inline ::Protocol::PlayerType S_TEST::_internal_playertype() const {
  return static_cast< ::Protocol::PlayerType >(playertype_);
}
inline ::Protocol::PlayerType S_TEST::playertype() const {
  // @@protoc_insertion_point(field_get:Protocol.S_TEST.playerType)
  return _internal_playertype();
}
inline void S_TEST::_internal_set_playertype(::Protocol::PlayerType value) {
  
  playertype_ = value;
}
inline void S_TEST::set_playertype(::Protocol::PlayerType value) {
  _internal_set_playertype(value);
  // @@protoc_insertion_point(field_set:Protocol.S_TEST.playerType)
}
